...
interface NeuralPasswordInputProps extends Omit<React.InputHTMLAttributes<HTMLInputElement>, "type"> {
    label?: string;
...
export const NeuralPasswordInput = React.forwardRef<HTMLInputElement, NeuralPasswordInputProps>(
...
NeuralPasswordInput.displayName = "NeuralPasswordInput";
