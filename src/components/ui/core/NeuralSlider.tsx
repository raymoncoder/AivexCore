...
interface NeuralSliderProps extends React.InputHTMLAttributes<HTMLInputElement> {
    min: number;
    max: number;
    step?: number;
    label?: string;
...
export const NeuralSlider = React.forwardRef<HTMLInputElement, NeuralSliderProps>(
...
NeuralSlider.displayName = "NeuralSlider";
