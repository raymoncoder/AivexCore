...
interface AivexInputProps extends React.InputHTMLAttributes<HTMLInputElement> {
...
export const AivexInput = React.forwardRef<HTMLInputElement, AivexInputProps>(
...
AivexInput.displayName = "AivexInput";
