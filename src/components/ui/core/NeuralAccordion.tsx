...
interface NeuralAccordionItemProps {
    value: string;
    title: string;
...
const NeuralAccordionItem = ({ value, title, children, isOpen, onClick }: NeuralAccordionItemProps) => {
    return (
...
interface NeuralAccordionProps {
...
export const NeuralAccordion = ({ items, type = "single", defaultValue, className }: NeuralAccordionProps) => {
