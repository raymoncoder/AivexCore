...
export interface AivexSelectOption {
    value: string;
    label: string;
    description?: string;
...
interface AivexSelectProps {
    options: AivexSelectOption[];
...
export const AivexSelect = ({
    ...
    const [selected, setSelected] = useState<AivexSelectOption | null>(
    ...
    const handleSelect = (option: AivexSelectOption) => {
        setSelected(option);
