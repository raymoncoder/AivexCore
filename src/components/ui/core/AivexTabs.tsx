...
export function AivexTabsContent({ value, activeValue, children, className }: { value: string, activeValue: string, children: React.ReactNode, className?: string }) {
