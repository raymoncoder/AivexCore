...
export const NeuralTooltip = ({ children, content, position = "top", delay = 0.5, className }: NeuralTooltipProps) => {
            ...
            <AnimatePresence>
                {isVisible && (
                    <motion.div
                        ...
                        className={cn(
                            "absolute z-50 px-3 py-1.5 bg-zinc-900 border border-zinc-700 rounded-lg text-xs font-onest text-zinc-100 shadow-xl backdrop-blur-md whitespace-nowrap min-w-[max-content]",
                            {
