...
interface NeuralNumberInputProps extends Omit<React.InputHTMLAttributes<HTMLInputElement>, "type"> {
    label?: string;
...
export const NeuralNumberInput = React.forwardRef<HTMLInputElement, NeuralNumberInputProps>(
...
NeuralNumberInput.displayName = "NeuralNumberInput";
