...
interface AivexTextareaProps extends React.TextareaHTMLAttributes<HTMLTextAreaElement> {
    wrapperClassName?: string;
    label?: string;
}

export const AivexTextarea = React.forwardRef<HTMLTextAreaElement, AivexTextareaProps>(
...
AivexTextarea.displayName = "AivexTextarea";
