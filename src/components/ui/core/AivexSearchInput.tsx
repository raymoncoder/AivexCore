...
interface AivexSearchInputProps extends Omit<React.InputHTMLAttributes<HTMLInputElement>, "type"> {
    label?: string;
...
export const AivexSearchInput = React.forwardRef<HTMLInputElement, AivexSearchInputProps>(
...
AivexSearchInput.displayName = "AivexSearchInput";
