...
interface AivexDataTableProps<T> {
    data: T[];
    columns: Column<T>[];
    pageSize?: number;
    selectable?: boolean;
...
export const AivexDataTable = <T extends { id: string | number }>({
    data,
    columns,
    pageSize = 5,
    selectable = true,
}: AivexDataTableProps<T>) => {
        ...
        <div className="w-full space-y-4">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                    ...
                    />
                    <AivexButton variant="ghost" size="sm" className="h-9 px-3 text-zinc-400">
                        <Filter size={14} className="mr-2" />
                        Filter
                    </AivexButton>
                </div>
                <div className="flex items-center gap-2">
                    <AivexButton variant="secondary" size="sm" className="h-9">
