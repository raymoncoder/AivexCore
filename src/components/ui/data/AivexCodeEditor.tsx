...
interface AivexCodeEditorProps {
    initialCode?: string;
    language?: string;
    className?: string;
    title?: string;
...
export const AivexCodeEditor = ({
    initialCode = "",
    language = "tsx",
    className,
    title = "index.tsx",
    readOnly = false
}: AivexCodeEditorProps) => {
        ...
        <div className={cn(
            ...
            <div className="relative flex-1 font-mono text-sm leading-relaxed overflow-auto max-h-[500px]">
                <Editor
                    ...
                    className="Aivex-editor-textarea focus:outline-none"
                    disabled={readOnly}
                />

                {/* Custom styling for Prism tokens to match Aivex theme */}
                <style jsx global>{`
                    .Aivex-editor-textarea pre {
